...
// Helper untuk mengambil buffer dari URL
...
// Helper Upload Gambar ke Telegraph (Untuk Maker AI)
...
async function startBot() {
    ...
    const { version } = await fetchLatestBaileVersion = await fetchLatestBaileysVersion();
    ...
    if (!sock.authState.creds.registered) {
        ...
        const phoneNumber = await question('\x1b[37m[?] Masukkan Nomor WhatsApp Bot Anda: \x1b[0m');
    ...
    sock.ev.on('messages.upsert', async ({ messages, type }) => {
        ...
        // Handler Otomatis untuk Semua Command Maker AI Gambar (30+ Perintah)
        ...
        if (aiMakerRegex.test(command)) {
            let qMsg = m.quoted ? m.quoted.quotedMessage : m.message;
        ...
        switch (command) {
            ...
            case 'owner-tt':
                await sock.sendMessage(from, { text: "Link TikTok Owner ZYY-CYBER:\n👉 https://www.tiktok.com/@zyyzall" }, { quoted: m });
                break;
            case 'owner-ig':
                await sock.sendMessage(from, { text: "Link Instagram Owner ZYY-CYBER:\n👉 https://www.instagram.com/abcdeezall" }, { quoted: m });
                break;
            case 'owner-channel':
                await sock.sendMessage(from, { text: "Link Saluran WhatsApp Resmi ZYY-CYBER:\n👉 https://whatsapp.com/channel/0029Vb8F5QwLCoWyFrBbFz0v" }, { quoted: m });
                break;

            // ==========================================================
            // SALURAN / NEWSLETTER FEATURES
            // ==========================================================
            case 'cekidch':
            case 'idch': {
                ...
                try {
                    ...
                    await sock.sendMessage(from, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                title: name,
                                body: "Channel berhasil dibuat via ZYY-CYBER System",
            ...
            case 'addmoney': {
                ...
                await sock.sendMessage(from, { text: `Sukses menambahkan Rp ${formatNumber(nominal)}` }, { quoted: m });
                break;
            }
        }
    });
